...
#define Z_ENABLE_INIT SET_OUTPUT_REGISTER(Z_ENABLE_PORT,Z_ENABLE_MASK)//SET_OUTPUT(Z_ENABLE_PIN) 
#define Z_ENABLE_WRITE(STATE) WRITE(Z_ENABLE_PIN,STATE)//WRITE_REGISTER(Z_ENABLE_PORT,Z_ENABLE_MASK,STATE)
#define Z_ENABLE_READ READ(Z_ENABLE_PIN) //READ_REGISTER(Z_ENABLE_PORT,Z_ENABLE_MASK)
...
// E0 motor
#define E0_STEP_INIT SET_OUTPUT_REGISTER(E0_STEP_PORT,E0_STEP_MASK)//SET_OUTPUT(E0_STEP_PIN)
#define E0_STEP_WRITE(STATE) WRITE(E0_STEP_PIN,STATE)
#define E0_STEP_READ READ(E0_STEP_PIN)

#define E0_DIR_INIT SET_OUTPUT_REGISTER(E0_DIR_PORT,E0_DIR_MASK)//SET_OUTPUT(E0_DIR_PIN)
#define E0_DIR_WRITE(STATE) WRITE(E0_DIR_PIN,STATE)
#define E0_DIR_READ READ(E0_DIR_PIN)

#define E0_ENABLE_INIT SET_OUTPUT_REGISTER(E0_ENABLE_PORT,E0_ENABLE_MASK)//SET_OUTPUT(E0_ENABLE_PIN)
