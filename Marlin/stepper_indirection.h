...
#define Z_ENABLE_WRITE(STATE) WRITE_REGISTER(Z_ENABLE_PORT,Z_ENABLE_MASK,STATE)//WRITE(Z_ENABLE_PIN,STATE)
#define Z_ENABLE_READ READ_REGISTER(Z_ENABLE_PORT,Z_ENABLE_MASK)//READ(Z_ENABLE_PIN)
